...
class SingleProductTotalReview extends StatefulWidget {
  ...
  @override
  State<SingleProductTotalReview> createState() =>
      _SingleProductTotalReviewState();
}
          ...
          children: [
            Column(
              ...
              children: [
                ...
                MyGoogleText(
                  text:
                      '${lang.S.of(context).totalReviews}${widget.productReviewModel!.length}',
                  fontSize: 16,
                  fontWeight: FontWeight.normal,
                        ...
                        Row(
                          children: [
                            ...
                            LinearPercentIndicator(
                              ...
                              lineHeight: 8.0,
                              percent:
                                  ((fiveStarRating(widget.productReviewModel) *
                                              100) /
                                          widget.productReviewModel!.length
                                              .toInt()) /
                                      100,
                        ...
                        Row(
                          children: [
                            ...
                            LinearPercentIndicator(
                              ...
                              lineHeight: 8.0,
                              percent:
                                  ((fourStarRating(widget.productReviewModel) *
                                              100) /
                                          widget.productReviewModel!.length
                                              .toInt()) /
                                      100,
                            ...
                            SizedBox(
                                width: 30,
                                child: Center(
                                    child: Text(fourStarRating(
                                            widget.productReviewModel)
                                        .toString()))),
                          ],
                        ),
                        Row(
                          children: [
                            ...
                            LinearPercentIndicator(
                              ...
                              lineHeight: 8.0,
                              percent:
                                  ((threeStarRating(widget.productReviewModel) *
                                              100) /
                                          widget.productReviewModel!.length
                                              .toInt()) /
                                      100,
                        ...
                        Row(
                          children: [
                            ...
                            LinearPercentIndicator(
                              ...
                              lineHeight: 8.0,
                              percent:
                                  ((twoStarRating(widget.productReviewModel) *
                                              100) /
                                          widget.productReviewModel!.length
                                              .toInt()) /
                                      100,
                        ...
                        Row(
                          children: [
                            ...
                            LinearPercentIndicator(
                              ...
                              lineHeight: 8.0,
                              percent:
                                  ((oneStarRating(widget.productReviewModel) *
                                              100) /
                                          widget.productReviewModel!.length
                                              .toInt()) /
                                      100,
