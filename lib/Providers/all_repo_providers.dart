...
final getProductOfSingleCategory =
    FutureProvider.family<List<ProductModel>, int>((ref, id) {
...
final getSingleProductVariation =
    FutureProvider.family<List<SingleProductVariations>, int>((ref, id) {
...
final getProductBySearch =
    FutureProvider.family<List<ProductModel>, String>((ref, name) {
