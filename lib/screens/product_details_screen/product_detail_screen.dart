...
import 'package:woocommerce_app/models/product_model.dart';
import 'package:woocommerce_app/models/single_product_variations_model.dart';
import 'package:woocommerce_app/screens/cart_screen/cart_screen.dart';
import 'package:woocommerce_app/widgets/buttons.dart';
import 'package:woocommerce_app/widgets/castomar_review_commends.dart';
import 'package:woocommerce_app/widgets/single_product_total_review.dart';
...
class _ProductDetailScreenState extends State<ProductDetailScreen> {
  ...
  void initState() {
    ...
    simpleProductDiscount = discountGenerator(
        widget.productModel.regularPrice!, widget.productModel.salePrice!);
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer(builder: (context, ref, __) {
      final singleCategory =
          ref.watch(getProductOfSingleCategory(widget.categoryId));
      final productVariation =
          ref.watch(getSingleProductVariation(widget.productModel.id!.toInt()));
      return Scaffold(
                            ...
                            itemBuilder: (BuildContext context, int itemIndex,
                              ...
                              child: Image(
                                image: NetworkImage(widget
                                    .productModel.images![itemIndex].src!),
                              ),
                            ),
                          ),
                            ...
                            child: Column(
                              children: [
                                ...
                                GestureDetector(
                                  onTap: () {
                                    Share.share(
                                        '${widget.productModel.name}. Buy Now at: ${Config.websiteURL}?p=${widget.productModel.id}');
                                  },
                                  child: Container(
                                    height: 35,
                                    width: 35,
                            ...
                            Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  simpleProductDiscount != 202 ||
                                          widget.productModel.salePrice!
                                              .isNotEmpty
                                      ? Row(
                                          children: [
                                            MyGoogleText(
                                              text: widget.productModel.type !=
                                                      'simple'
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          ...
                                          style:
                                              GoogleFonts.dmSans(fontSize: 18),
                                        ),
                                        GestureDetector(
                                          onTap: () {
                                            setState(() {
                                        ...
                                        children: <Widget>[
                                          Padding(
                                            padding: const EdgeInsets.only(
                                                bottom: 12),
                                            child: ReadMoreText(
                                              intl.Bidi.stripHtmlIfNeeded(widget
                                              ...
                                              trimCollapsedText:
                                                  lang.S.of(context).showMore,
                                              trimExpandedText:
                                                  lang.S.of(context).showLess,
                                            ),
                                          ),
                                        ],
                                      ),
                    ...
                    if (counter <= 1) {
                      for (int i = 0; i < snapShot[0].attributes!.length; i++) {
                        ...
                        for (var element in snapShot) {
                          demoList
                              .add(element.attributes![i].option.toString());
                        }
                          ...
                          children: [
                            ...
                            CarouselSlider.builder(
                              ...
                              itemBuilder: (BuildContext context, int itemIndex,
                                ...
                                width: double.infinity,
                                child: Image(
                                  image: NetworkImage(variationImage != ''
                                      ? variationImage
                                      : widget.productModel.images![itemIndex]
                                          .src!),
                                ),
                              ),
                            ),
                              ...
                              child: Column(
                                children: [
                                  ...
                                  GestureDetector(
                                    onTap: () {
                                      Share.share(
                                          '${widget.productModel.name}. Buy Now at: https://www.indikeon.com/?p=${widget.productModel.id}');
                                    },
                                    child: Container(
                                      height: 35,
                                      width: 35,
                    ...
                    return Expanded(
                      child: ButtonType2(
                          buttonText: alreadyInCart
                              ? lang.S.of(context).goToCartButton
                              : lang.S.of(context).addToCartButton,
                          buttonColor: kPrimaryColor,
                          onPressFunction: () {
                            if (!alreadyInCart) {
                              cart.addItemInfo(CartOtherInfo(
