...
import 'package:woocommerce_app/screens/order_screen/order_details.dart';
          ...
          body: SingleChildScrollView(
            child: getAllOrders.when(data: (snapShot) {
              if (snapShot.isNotEmpty) {
                              ...
                              child: Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    MyGoogleText(
                                      text:
                                          '${lang.S.of(context).orderId}${snapShot[index].id}',
                                      fontSize: 16,
                                      fontColor: isDark
                                          ? darkTitleColor
                                          : lightTitleColor,
                                    ...
                                    SizedBox(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          MyGoogleText(
                                            text:
                                                '${lang.S.of(context).cartItems} (${snapShot[index].lineItems!.length})',
                                            fontSize: 16,
                                            fontColor: isDark
                                                ? darkGreyTextColor
                                                : lightGreyTextColor,
                                          ...
                                          MyGoogleText(
                                            text:
                                                '${lang.S.of(context).totalAmount} \$${snapShot[index].total}',
                                            fontSize: 14,
                                            fontColor: isDark
                                                ? darkGreyTextColor
                                                : lightGreyTextColor,
                ...
                return Center(
                  child: MyGoogleText(
                      text: lang.S.of(context).noOrder,
                      fontSize: 16,
