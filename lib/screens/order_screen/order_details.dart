              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    SizedBox(
                      ...
                      child: Row(
                        ...
                        children: [
                          MyGoogleText(
                            text:
                                '${lang.S.of(context).orderId}${widget.order.id.toString()}',
                            fontSize: 18,
                            fontColor:
                    ...
                    MyGoogleText(
                      text:
                          '${lang.S.of(context).cartItems} (${widget.order.lineItems!.length})',
                      fontSize: 18,
                      fontColor: isDark ? darkTitleColor : lightTitleColor,
                      fontWeight: FontWeight.normal,
                    ),
                                ...
                                children: [
                                  Padding(
                                    padding: const EdgeInsets.only(
                                        ...
                                        bottom: 5),
                                    child: MyGoogleText(
                                      text: widget.order.lineItems![index].name
                                          .toString(),
                                      fontSize: 16,
                                      fontColor: isDark
                                          ? darkTitleColor
                                    ...
                                    child: Padding(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          MyGoogleText(
                                            text:
                                                '${lang.S.of(context).price} $currencySign${widget.order.lineItems![index].total}',
                                            fontSize: 14,
                                            fontColor: isDark
                                                ? darkTitleColor
                                                : lightTitleColor,
                                          ...
                                          MyGoogleText(
                                            text:
                                                '${lang.S.of(context).quantity} ${widget.order.lineItems![index].quantity}',
                                            fontSize: 14,
                                            fontColor: isDark
                                                ? darkTitleColor
                                                : lightTitleColor,
                            ...
                            child: Column(
                              ...
                              children: <Widget>[
                                Padding(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      MyGoogleText(
                                          text:
                                              lang.S.of(context).cancelingOrder,
                                          fontSize: 16,
                                          fontColor: isDark
                                              ? darkGreyTextColor
                                              : lightGreyTextColor,
                                ...
                                Padding(
                                  ...
                                  child: Button1(
                                      buttonText:
                                          lang.S.of(context).cancelOrderButton,
                                      buttonColor: kPrimaryColor,
                                      onPressFunction: () {
                                        EasyLoading.show(
                                            status: lang.S
