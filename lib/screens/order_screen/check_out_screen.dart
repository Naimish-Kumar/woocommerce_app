...
class _CheckOutScreenState extends State<CheckOutScreen> {
                  ...
                  if (snapShot.hasData) {
                    if (snapShot.data!.shipping!.address1!.isEmpty ||
                      ...
                      Center(
                        child: Button1(
                            buttonText:
                                lang.S.of(context).addShippingAddressButton,
                                  ...
                                  Consumer(builder: (context, ref, child) {
                                    ...
                                    return Column(
                                      ...
                                      children: [
                                        MyGoogleText(
                                          text:
                                              '${lang.S.of(context).totalItems} ${cart.cartOtherInfoList.length}',
                                          fontSize: 18,
                                          fontColor: isDark
                                              ? darkTitleColor
                                              : lightTitleColor,
                                        ...
                                        side: BorderSide(
                                            color: whichPaymentIsChecked ==
                                                ...
                                                : isDark
                                                    ...
                                                    : secondaryColor3)),
                                    color:
                                        isDark ? darkContainer : Colors.white,
  ...
  Future<void> _handleSslCommerzPayment(
      CartNotifier cart, WidgetRef ref) async {
            ...
            paymentData: {
              ...
              "customer": {
                ...
                "phone": {
                  "country_code": "965",
                  "number":
                      retrieveCustomer?.shipping?.phone.toString() ?? 'Test',
                }
              },
              // "merchant": {"id": ""},
  ...
  //Create an order
  _handleOrderCreate(
      bool payment, String methodName, CartNotifier cart, WidgetRef ref) {
    EasyLoading.show(
      status: lang.S.of(context).easyLoadingCreatingOrder,
    );
    apiService
