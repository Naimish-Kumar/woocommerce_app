...
import 'package:woocommerce_app/api_service/api_service.dart';
import 'package:woocommerce_app/generated/l10n.dart' as lang;
import 'package:woocommerce_app/models/order_create_model.dart';
import 'package:woocommerce_app/screens/order_screen/check_out_screen.dart';
            ...
            Consumer(builder: (_, ref, child) {
              ...
              return Padding(
                ...
                child: Center(
                  child: MyGoogleText(
                    text:
                        '${cart.cartOtherInfoList.length} ${lang.S.of(context).cartItems}',
                    fontSize: 16,
                          ...
                          return Center(
                            child: Column(
                              children: [
                                ...
                                MyGoogleText(
                                  text: lang.S.of(context).ifNoItems,
                                  fontColor: isDark
                                      ? darkGreyTextColor
                                      : lightGreyTextColor,
                                                ...
                                                itemBuilder: (context, i) {
                                                  return Row(
                                                    children: [
                                                      MyGoogleText(
                                                        text:
                                                            '${cart.cartOtherInfoList[index].attributesName![i]} :',
                                              ...
                                              child: Padding(
                                                ...
                                                child: Row(
                                                  ...
                                                  children: [
                                                    MyGoogleText(
                                                      text:
                                                          '\$${cart.cartOtherInfoList[index].productPrice}',
                                                      fontSize: 16,
                                                      fontColor: isDark
                                                          ? darkTitleColor
                                                          : lightTitleColor,
                                                          ...
                                                          GestureDetector(
                                                            onTap: () {
                                                              setState(() {
                                                                ...
                                                                cart.cartOtherInfoList[index].quantity! >
                                                                        1
                            ...
                            onTap: () async {
                              try {
                                if (inputCoupon == '') {
                                  ...
                                  CouponLines coupon =
                                      CouponLines(code: inputCoupon);
                                  price.addCoupon(coupon);
                                  var promoPrice =
                                      await apiService?.retrieveCoupon(
                                          finalInputCoupon, totalPrice);
                                  if (promoPrice! > 0.0) {
                          ...
                          onPressFunction: () {
                            ScaffoldMessenger.of(context).showSnackBar(
                              SnackBar(
                                ...
                                content:
                                    Text(lang.S.of(context).addProductFirst),
                              ),
                            );
                          },
                        );
